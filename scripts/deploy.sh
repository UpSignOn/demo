...
# Clean demo
ssh b-upsignon@beta.upsignon.eu 'cd demo && rm -rf dist && mkdir -p dist && mkdir -p public-monptitshop && mkdir -p public-raoul && mkdir -p public-mapaye'
...
scp -p ./public/mapaye.html b-upsignon@beta.upsignon.eu:~/demo/public-mapaye/index.html
